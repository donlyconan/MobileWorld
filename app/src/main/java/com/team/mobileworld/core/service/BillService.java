...
public interface BillService {
	 ...
	 */
	@GET(URL_BILL)
	Call<List<Order>> loadBill(@Query("userid") long userid, @Query("type") int status);
	...
	Call<ResponseBody> updateStatusOrder(@Field("idbill") int idbill, @Field("status") int status);
